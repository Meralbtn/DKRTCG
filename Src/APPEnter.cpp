...
const VkExtent2D PR_BASE::APPEnter::getSwapChainExtent() const
{
    return swapChainExtent;
}

VkFormat PR_BASE::APPEnter::getVkFormat() const
{
    return swapChainImageFormat;
}

VkDevice PR_BASE::APPEnter::getDevice() const
{
    return device;
}
...
void PR_BASE::APPEnter::createPipeline()
{
}
